...
export default function Homepage() {
    const { movies, series, firstMovie, firstMovieImage, trailer, loading, firstMovieDetails, } = useMedia();
            ...
            <div className="container px-3 mx-auto">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                        {series.map((tv) => (
                            <Card key={tv.id} id={tv.id} name={tv.name} image={tv.poster_path} type={"serie"}/>
                        ))}
                    </div>
                </section>
            </div>
